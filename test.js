...
test('next', function (t) {
  t.table_assert([
    [ 'src', 'iterations', 'exp' ],
    [ '"a"', 3, 's3@0:A_AV,E@3:A_AV,E@3:A_AV' ],
    [ '"a",', 3, 's3@0:A_AV,E@4:A_BV,E@4:A_BV' ],
    [ '"a",3', 4, 's3@0:A_AV,E1@4!D:A_BV,E@5:A_BV,E@5:A_BV' ],
    [ '"a",3,', 4, 's3@0:A_AV,d1@4:A_AV,E@6:A_BV,E@6:A_BV' ],
    [ '"a",3,t', 5, 's3@0:A_AV,d1@4:A_AV,E1@6!T:A_BV,E@7:A_BV,E@7:A_BV' ]
    ...
    for (var i = 0; i < iterations; i++) {
      ...
      results.push(qbnext.tokstr(ps, true))
    }
    return results.join(',')
  })
})
